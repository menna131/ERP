...
<head>
    ...
    <link rel="stylesheet" href="{{url('material/css/bootstrap/4.3.1/css/bootstrap.min.css')}}"
        ...
        <link href="{{url('material/css/npm/select2@4.1.0-rc.0/dist/css/select2.min.css')}}" rel="stylesheet" />
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <select name="" id="items" class="select-2">
                                <option value="1">opt1</option>
                                <option value="2">opt2</option>
                                <option value="3">opt13</option>
                   </select>
                </div>
    ...
    <script src="{{ url('material/js/bootstrap/4.3.1/js/bootstrap.min.js') }}"
        integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous">
          ...
          <script src="{{ url('material/js/npm/select2@4.1.0-beta.1/dist/js/select2.min.js') }}"></script>
<script>
    $('#items').select2();
</script>
</body>
