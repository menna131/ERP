<!DOCTYPE html>
@php app()->getLocale() == 'ar' ? $dir = 'rtl' : $dir = 'ltr' @endphp
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('material') }}/css/ajax/libs/jasny-bootstrap/4.0.0/css/jasny-bootstrap.min.css">
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no'
        name='viewport' />
    <!--     Fonts and icons     -->
    <link rel="stylesheet" href="{{ asset('material') }}/css/font-awesome/latest/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('material') }}/css/fonts.css">
    ...
    <link href="{{ asset('material') }}/css/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
    <script src="{{ asset('material') }}/js/core/jquery.min.js"></script>
      <script src="{{ asset('material') }}/js/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>
...
<body class="  {{ app()->getLocale() == 'ar' ? ' rtl  rtl menu-on-right ' : '' }} {{ $class ?? '' }}">
    @if(Auth::user())
        ...
        @if(Auth::user()->email_verified_at)
            @if(isset($setting_check))
                @if( $setting_check->status  != 1 )
    ...
    <script src="{{ asset('material') }}/js/ajax/libs/jasny-bootstrap/4.0.0/js/jasny-bootstrap.min.js"></script>
    ...
    <script src="{{ asset('material') }}/js/ajax/libs/core-js/2.4.1/core.js"></script>
