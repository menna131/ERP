            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-mode">
                        ...
                        <div class="m-5">
                            <div class="card-body">
                                <form method="POST" action="{{ route('expenses.update', $expense->slug) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group ">
                                            ...
                                            <input type="number" name="value" value="{{ $expense->value }}" class="form-control" id="expensevalue"
                                                required>
                                            @error('value')
                                        ...
                                        <div class="col-6 form-group">
                                            <p class="font-weight-bold" for="inputAddress">
                                                ...
                                                <input type="date" name="date" value="{{ $expense->date }}" class="form-control" id="expensedate"
                                                    required>
                                                @error('date')
                                                <div class="alert alert-danger"> {{ $message }} </div>
                                                @enderror
                                    ...
                                    <div class="form-group">
                                        <p class="font-weight-bold" for="inputAddress">
                                            ...
                                            <select class="form-control form-group" name="expense_Type_id" style="width: 100%">
                                                <option value="{{ $expense->expense_type_id }}">{{ $expense->expense_type->type }}</option>
