@extends('layouts.app', ['activePage' => 'allexpensestypes', 'titlePage' => __('translation.website.sidebar.All Expenses Types')])
                    ...
                    <div class="card card-mode">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive-sm">
                                ...
                                <form method='post' class='d-inline' action="{{ route('expensesTypes.destroy', 1) }}" id='delete'>
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
