@extends('layouts.app', ['activePage' => 'showwalletclientTransaction', 'titlePage' =>
                    ...
                    <div class="card card-mode">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table" id="data-table">
                             ...
                             <form method='post' class='d-inline' action="{{ route('destroy.wallet.trans',1) }}" id='delete'>
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#data-table').DataTable({
                ...
                ajax: '{!! route('clientWalletTrans.data', $clientwallet->slug) !!}',
                ...
                columns: [{
                    ...
                    {
                        data: 'client_wallet_transactionable_type',
                        name: 'client_wallet_transactionable_type',
                        orderable: true,
                        searchable: true
                    },
                    {
