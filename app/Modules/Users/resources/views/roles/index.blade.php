                ...
                <div class="col-md-12">
                    <div class="card card-mode">
                        <div class="card-header card-header-text card-header-primary">
                            <div class="card-text">
                                <h4 class="card-title">{{ __('translation.website.sidebar.All Roles') }}</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="col-lg-12 text-right">
                                <a href="{{ route('roles.create') }}" rel="tooltip"
                                    title="{{ __('translation.title.create role') }}" class="btn btn-primary btn-round mb-3"><i
                            ...
                            <table class="table" id="data-table">
                                <thead>
                                    <tr>
                                        <th class="text-center">{{ __('translation.roles.ID') }}</th>
                                        <th>{{ __('translation.roles.Name') }}</th>
                                        <th>{{ __('translation.website.crud.Actions') }}</th>
                                    </tr>
                                </thead>
                            </table>
                            <form method='post' class='d-inline' action="{{route('roles.destroy',1)}}" id='delete'>
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
